...
public class DemoEmployee {
	...
	public static void main(String[] args) {
		...
		emp3.whoAmI();
		// TODO To complete
		// emp3.whoAmI() // prints ... because ... the method whoAmI is overriden by parent employee 
		// emp3.getHourlyRate(); // returns syntax error because ... The method only exists in child class
		...
		// TODO To complete
		// This instruction compiles / does not compile   It does not compile
		// This instruction returns a ClassCastException at run time
		// because ...  pEmp3 is not cast as the parent class
